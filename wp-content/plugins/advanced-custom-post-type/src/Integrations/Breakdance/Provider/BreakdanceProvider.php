...
class BreakdanceProvider
{
	...
	public static function init()
	{
		...
		foreach ($fields as $field){
		    foreach ($field['fields'] as $f){
                $breakdanceField = self::getBreakdanceField($f, $field['belongsTo'], $field['find']);
                $breakdanceFieldAsUrl = self::getBreakdanceFieldAsUrl($f, $field['belongsTo'], $field['find']);
	 ...
	 */
	private static function getBreakdanceField(MetaFieldModel $fieldModel, $belongsTo = null, $find = null)
	{
		$fieldType = null;
		...
		if(class_exists($className)){
			return new $className($fieldModel, $belongsTo, $find);
		}
	 ...
	 * @return null|ACPTFieldInterface
	 */
	private static function getBreakdanceFieldAsUrl(MetaFieldModel $fieldModel, $belongsTo = null, $find = null)
	{
		$fieldType = null;
