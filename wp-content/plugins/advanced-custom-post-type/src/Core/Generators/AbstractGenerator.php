	...
	protected static function generateQuickEditField($key, $label, $value, MetaFieldModel $metaBoxFieldModel)
	{
		...
		switch ($metaBoxFieldModel->getType()){
            ...
            case MetaFieldModel::DATE_TIME_TYPE:
                $return .= '<input type="datetime-local" name="'. $key. '" data-acpt-column="column-'. $key. '" class="inline-edit-menu-order-input" value="'. $value.'">';
                break;
            ...
            case MetaFieldModel::TIME_TYPE:
                $return .= '<input type="time" name="'. $key. '" data-acpt-column="column-'. $key. '" class="inline-edit-menu-order-input" value="'. $value.'">';
                break;
