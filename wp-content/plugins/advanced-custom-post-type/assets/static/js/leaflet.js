...
window.onload = function () {
     ...
     *
     * @param mapPreview
     * @return {{defaultCity: string, searchBoxCity: string, searchInput: *, lngInput: ({value}|*), searchBoxLng: string, defaultLng: number, cityInput: ({value}|*), searchBoxLat: string, mapPreviewId: *, defaultLat: number, latInput: ({value}|*), searchBoxId: *}}
     */
