...
class MigrateMeta extends ACPT_Schema_Migration
{
	...
	public function up(): array
	{
		...
		$queries = array_merge($queries, [
			"DROP TABLE `".ACPT_DB::prefixedTableName(ACPT_DB::TABLE_TAXONOMY_META_BOX)."`",
			"DROP TABLE `".ACPT_DB::prefixedTableName(ACPT_DB::TABLE_OPTION_PAGE_META_BOX)."`",
			"DROP TABLE `".ACPT_DB::prefixedTableName(ACPT_DB::TABLE_USER_META_BOX)."`",
			"DROP TABLE `".ACPT_DB::prefixedTableName(ACPT_DB::TABLE_CUSTOM_POST_TYPE_META_BOX)."`;",
			"DROP TABLE `".ACPT_DB::prefixedTableName(ACPT_DB::TABLE_CUSTOM_POST_TYPE_FIELD)."`;",
			"DROP TABLE `".ACPT_DB::prefixedTableName(ACPT_DB::TABLE_CUSTOM_POST_TYPE_ADVANCED_OPTION)."`;",
			"DROP TABLE `".ACPT_DB::prefixedTableName(ACPT_DB::TABLE_CUSTOM_POST_TYPE_OPTION)."`;",
			"DROP TABLE `".ACPT_DB::prefixedTableName(ACPT_DB::TABLE_CUSTOM_POST_TYPE_VISIBILITY)."`;",
			"DROP TABLE `".ACPT_DB::prefixedTableName(ACPT_DB::TABLE_CUSTOM_POST_TYPE_RELATION)."`;",
			"DROP TABLE `".ACPT_DB::prefixedTableName(ACPT_DB::TABLE_CUSTOM_POST_TYPE_BLOCK)."`;",
			"DROP TABLE `".ACPT_DB::prefixedTableName(ACPT_DB::TABLE_USER_META_FIELD)."`;",
			"DROP TABLE `".ACPT_DB::prefixedTableName(ACPT_DB::TABLE_USER_META_FIELD_OPTION)."`;",
			"DROP TABLE `".ACPT_DB::prefixedTableName(ACPT_DB::TABLE_CUSTOM_POST_TEMPLATE)."`;",
