...
class FormGeneratorTest extends AbstractTestCase
{
	...
	public function canRenderTheForm()
	{
		...
		$this->assertEquals("actp-form-label", $textInputLabel->getAttribute("class"));
		...
		$this->assertEquals("actp-form-control", $textInput->getAttribute("class"));
		...
		$this->assertEquals("actp-form-label", $urlInputLabel->getAttribute("class"));
		...
		$this->assertEquals("actp-form-control", $urlInput->getAttribute("class"));
		...
		$this->assertEquals("actp-form-control", $urlLabelInput->getAttribute("class"));
