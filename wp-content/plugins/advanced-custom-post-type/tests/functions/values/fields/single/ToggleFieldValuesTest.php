...
class ToggleFieldValuesTest extends AbstractTestCase
{
    /**
     * @test
     */
    ...
    public function can_display_acpt_meta_field()
    {
	    foreach ($this->dataProvider() as $key => $value){
		    ...
		    $this->assertEquals('<span class="acpt-toggle-placeholder" style="font-size: 36px;"><span class="iconify" data-icon="bx:bx-check-circle" style="color: #02c39a;"></span></span>', $acpt_field);
	    }
