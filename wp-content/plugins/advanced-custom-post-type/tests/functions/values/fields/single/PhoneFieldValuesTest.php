...
class PhoneFieldValuesTest extends AbstractTestCase
{
    ...
    public function can_add_acpt_meta_field_value()
    {
	    ...
	    foreach ($this->dataProvider() as $key => $value){
		    ...
		    $this->assertEquals('+39123456789', $acpt_field);
	    }
    }
    ...
    public function can_edit_acpt_meta_field_value()
    {
	    foreach ($this->dataProvider() as $key => $value){
		    ...
		    $this->assertEquals('+39987654321', $acpt_field);
	    }
    }
    ...
    public function can_display_acpt_meta_field()
    {
	    foreach ($this->dataProvider() as $key => $value){
		    ...
		    $this->assertEquals('<a href="tel:+39987654321" target="_blank">+39987654321</a>', $acpt_field);
	    }
    }
