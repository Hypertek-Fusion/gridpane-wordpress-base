...
class EmbedFieldValuesTest extends AbstractTestCase
{
    /**
     * @test
     */
    public function can_add_acpt_meta_field_value()
    {
	    ...
	    foreach ($this->dataProvider() as $key => $value){
		    $add_acpt_meta_field_value = save_acpt_meta_field_value([
			    ...
			    'box_name' => 'box_name',
			    'field_name' => 'embed',
			    'value' => "https://vimeo.com/747562251",
		    ]);
		    ...
		    $this->assertEquals('https://vimeo.com/747562251', $acpt_field);
	    }
    }
    ...
    public function can_edit_acpt_meta_field_value()
    {
	    foreach ($this->dataProvider() as $key => $value){
		    $edit_acpt_meta_field_value = save_acpt_meta_field_value([
			    ...
			    'box_name' => 'box_name',
			    'field_name' => 'embed',
			    'value' => "https://youtu.be/araynbe6fJY",
		    ]);
		    ...
		    $this->assertEquals('https://youtu.be/araynbe6fJY', $acpt_field);
	    }
    ...
    public function can_display_acpt_meta_field()
    {
	    foreach ($this->dataProvider() as $key => $value){
		    ...
		    $this->assertEquals('<iframe title="Parimpampum @Stark&#039;s Cafè - Medley Cavalieri del Re" width="200" height="113" src="https://www.youtube.com/embed/araynbe6fJY?feature=oembed" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>', $acpt_field);
	    }
    }
