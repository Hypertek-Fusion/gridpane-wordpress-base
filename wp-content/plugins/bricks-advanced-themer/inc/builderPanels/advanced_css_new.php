...
$elements = array(
    array(
        ...
        "contentSass" => esc_html($page_custom_sass),
        "order" => 0,
        "default" => true,
        "saveMethod" => "builder",
        "toggleActive" => false,
    ...
    array(
        ...
        "contentSass" => esc_html($global_custom_sass),
        "order" => 1,
        "default" => true,
        "saveMethod" => "ajax",
        "toggleActive" => false,
...
if($brxc_acf_fields['advanced_css_enable_sass']){
    $elements[] = array(
        ...
        "readOnly" => false,
        "contentSass" => esc_html($mixins_content),
        "order" => 2,
        "default" => true,
        "status" => 1,
        "saveMethod" => "ajax",
    ...
    $elements[] = array(
        ...
        "readOnly" => false,
        "contentSass" => esc_html($partials_content),
        "order" => 3,
        "default" => true,
        "status" => 1,
        "saveMethod" => "ajax",
    ...
    if ( AT__Helpers::is_array( $results ) ) {
        foreach ( $results as $row ) {
            ...
            $elements[] = [
                ...
                "contentSass" => esc_html(stripslashes($row->original_code)),
    ...
    if(AT__Helpers::is_array($recipes)){
        foreach ($recipes as $key => $value){
            $elements[] = [
                ...
                "readOnly" => true,
                "contentCss" => esc_html(stripslashes($value)),
                "status" => 1,
                "saveMethod" => false,
                "toggleActive" => false,
                "default" => true,
    ...
    foreach($at_global_settings_arr['advanced_css'] as $item){
        ...
        if($item['typeLabel'] == "recipe"){
            ...
            $elements[] = [
                ...
                "readOnly" => false,
                "contentCss" => esc_html(stripslashes($contentCss)),
        ...
        // Custom StyleSheets
            ...
            $obj = [
                ...
                "contentSass" => esc_html($contentSass),
                "order" => $i,
                "status" => esc_html($item['status']),
