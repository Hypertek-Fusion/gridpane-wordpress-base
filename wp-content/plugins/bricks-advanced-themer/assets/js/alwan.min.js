...
function ColorPicker(t, e) {
    (this.element = t),
        ...
        t.addEventListener("click", function () {
            (colorPickerComp.instance = this.colorPickerObj), (colorPickerComp.pickerOpen = !0, colorPickerComp.hasChanges = !1);
...
document.addEventListener("mousedown", function () {
    ...
    (colorPickerComp.colorChange = function (t, e) {
        ...
        r.setAttribute("data-color", l), (r.style.background = l),colorPickerComp.hasChanges ? r.dispatchEvent(c) : '';
    }),
    ...
    document.getElementById("hex_input").addEventListener("blur", function () {
        const t = this.value;
        t.match(/^#[0-9a-fA-F]{3}([0-9a-fA-F]{3})?([0-9a-fA-F]{2})?$/) && (colorPickerComp.updateColorDisplays(t), colorPickerComp.hasChanges = 1, updatePicker());
    }),
    document.getElementById("hex_input").addEventListener("keyup", function (e) {
        if(e.key === "Enter" || e.key === "Tab"){
            ...
            const t = this.value;
            t.match(/^#[0-9a-fA-F]{6}$/) && (colorPickerComp.updateColorDisplays(t), colorPickerComp.hasChanges = 1, updatePicker());
       }
   }),
    document.querySelectorAll(".rgba_input").forEach((t) => {
        t.addEventListener("change", function () {
            ...
            colorPickerComp.updateColorDisplays(`rgba(${t[0].value}, ${t[1].value}, ${t[2].value}, ${t[3].value})`), colorPickerComp.hasChanges = 1, updatePicker();
        });
    }),
    document.querySelectorAll(".hsla_input").forEach((t) => {
        t.addEventListener("change", function () {
            ...
            if (t[3].value > 1) throw "Value must be equal to or below 1";
            colorPickerComp.updateColorDisplays(`hsla(${t[0].value}, ${t[1].value}%, ${t[2].value}%, ${t[3].value})`), colorPickerComp.hasChanges = 1, updatePicker();
        });
    }),
    ...
    (colorPickerComp.colorBoxHandler = function (t, e, o) {
        ...
        (colorPickerComp.saturation = i), (colorPickerComp.lightness = u), colorPickerComp.updateColorValueInput(), colorPickerComp.instance.element.setAttribute("data-color", "color"), colorPickerComp.hasChanges = 1, updatePicker();
    }),
