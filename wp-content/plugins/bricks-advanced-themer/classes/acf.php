                        ...
                        'sub_fields' => array(
                            ...
                            array(
                                ...
                                'choices' => array(
                                   ...
                                   'responsive-slider' => '<span>Breakpoint Slider <a href="#" class="dashicons dashicons-info acf-js-tooltip" title="This function unlock the breakpoint slider to easily slide between different breakpoints."></a></span>',
                                   'zoom-out' => '<span>Zoom-out <a href="#" class="dashicons dashicons-info acf-js-tooltip" title="This option adds a new icon inside the topbar - next to the scale input. Once clicked, it will scale down the window to get a better overview of your page and ease the drag & drop process of sections."></a></span>',
                                ),
                                'default_value' => array(
                                    'responsive-helper',
                                    'responsive-slider',
                            ...
                            array(
                                ...
                                'choices' => array(
                                    ...
                                    'quick-remote-template' => '<span>Quick Remote Template.<span class="new-feature">NEW</span><span class="legacy-feature">L</span><a href="#" class="dashicons dashicons-info acf-js-tooltip" title="This topbar icon allows you to quickly open the Quick Template modal and drag & drop your templates inside your page."></a></span>',
                                    ...
                                    'color-manager' => '<span>Global Color Manager. <span class="legacy-feature">L</span><a href="#" class="dashicons dashicons-info acf-js-tooltip" title="This topbar icon allows you to quickly open the Color Manager and create advanced color palettes"></a></span>',
                            ...
                            array(
                                ...
                                'choices' => array(
                                    ...
                                    'focus-mode' => '<span>Focus Mode <a href="#" class="dashicons dashicons-info acf-js-tooltip" title="When this option is enabled, holding the CMD Key (or CTRL for PC users) and clicking on any element within the Structure Panel will hide all the other elements around."></a></span>',
                                    'filterable-structure' => '<span>Filterable Structure Panel <span class="improved-feature">IMPROVED</span><a href="#" class="dashicons dashicons-info acf-js-tooltip" title="When this option is enabled, a new input on top of the Structure Panel will be added. Typing any keyword within this input will filter the elements inside the structure."></a></span>',
                                    //'multiselect' => '<span>Multi-edit Elements. <a href="#" class="dashicons dashicons-info acf-js-tooltip" title="When this option is checked, hold the SHIFT key and click on multiple elements inside the structure panel. Once selected, any style & class change will apply on all the selected elements at once."></a></span>',
                                ),
                                'default_value' => array(
                                    'new-element-shortcuts',
                                    'styles-and-classes-indicators',
                            ...
                            array(
                                ...
                                'choices' => array(
                                    ...
                                    'structure-helper' => '<span>Structure Helper Shortcut.<span class="legacy-feature">L</span><a href="#" class="dashicons dashicons-info acf-js-tooltip" title="When this option is enabled, a new icon will show up inside the structure panel\'s header. When clicked on it, a new panel will be shown where you can easily filter your structure panel by advanced helpers filters. This feature is now considered as LEGACY since it\'s available inside the topbar AT Main Menu."></a></span>',
                                    'locked-elements' => '<span>Lock Elements order. <a href="#" class="dashicons dashicons-info acf-js-tooltip" title="Check this toggle if you want to toggle the ability to drag/move elements inside the Structure Panel."></a></span>',
                                    'sticky-css' => '<span>Sticky CSS. <span class="new-feature">NEW</span><a href="#" class="dashicons dashicons-info acf-js-tooltip" title="Check this option if you want to toggle the ability to activate a permanent CSS Editor on steroids at the bottom of the Structure Panel."></a></span>',
                                ),
                                'default_value' => array(
                                    'ai-generated-structure',
                                    'structure-helper',
                            ...
                            array(
                                ...
                                'choices' => array(
                                    ...
                                    'hide-element' => '<span>Hide/Show Element. <span class="legacy-feature">L</span><a href="#" class="dashicons dashicons-info acf-js-tooltip" title="When clicked on this contextual menu item, the element will be set as display:none. If the element has display:none set, clicking the menu item will remove the display property. This feature is now considered as LEGACY since it\'s available inside the Class Contextual Menu."></a></span>',
                                    ...
                                    'class-converter' => '<span>Class Converter Shortcut. <span class="legacy-feature">L</span><a href="#" class="dashicons dashicons-info acf-js-tooltip" title="When clicked on this contextual menu item, a modal will show up and let you automatically convert the ID styles of an element (and his children) to an autogenerated class. This feature is now considered as LEGACY since it\'s available inside the Class Contextual Menu."></a></span>',
                                    'style-overview' => '<span>Style Overview Shortcut. <span class="legacy-feature">L</span><a href="#" class="dashicons dashicons-info acf-js-tooltip" title="When clicked on this contextual menu item, a modal will show up with all the styles and classes applied to the active element (including styles on different pseudo-element and breakpoints). This feature is now considered as LEGACY since it\'s available inside the Class Contextual Menu."></a></span>',
                            ...
                            array(
                                ...
                                'choices' => array(
                                    ...
                                    'variable-color-picker'  => '<span>Color Variables Picker <span class="improved-feature">IMPROVED</span><a href="#" class="dashicons dashicons-info acf-js-tooltip" title="When this option is checked, you\'ll enable a new right-click event on all the color inputs inside the builder. This action will open a color variable picker where you can visually select the color to apply to your control."></a></span>',
                            ...
                            array(
                                ...
                                'choices' => array(
                                    ...
                                    'link-spacing' => '<span>Link Spacing Controls by Default. <a href="#" class="dashicons dashicons-info acf-js-tooltip" title="When this option is checked, you can choose to link the values within the spacing controls of the builder - either all or only the opposites ones."></a></span>',
                            ...
                            array(
                                ...
                                'label' => 'Link Spacing Controls by Default ',
                            ...
                            array(
                                ...
                                'label' => 'Scroll/View Timeline Polyfill <span class="new-feature">NEW</span>',
                            ...
                            array(
                                ...
                                'label' => 'Global Logical Properties Converter <span class="new-feature">NEW</span>',
                                ...
                                'type' => 'checkbox',
                                'instructions' => 'Select the global elements you want to convert to logical properties and click on the "Convert Now" button.<div class="danger-links">⚠ This action is irreversible. Please back up your site before proceeding.</div>',
                                'required' => 0,
                                'wrapper' => array(
                                    'width' => '',
                                    'class' => '',
                                ...
                                'choices' => array(
                                    'elements' => '<span>Elements in Page/Posts <a href="#" class="dashicons dashicons-info acf-js-tooltip" title="Check this option to set the default HTML tag of all the basic text elements as a paragraph (p)."></a></span>',
                                    'templates' => '<span>Elements in Templates <a href="#" class="dashicons dashicons-info acf-js-tooltip" title="Check this option to set the default HTML tag of all the image elements as a figure."></a></span>',
                                    'global-classes' => '<span>Global Classes <a href="#" class="dashicons dashicons-info acf-js-tooltip" title="Check this option to set the default HTML tag of all the image elements as a figure."></a></span>',
                                    'components' => '<span>Components <a href="#" class="dashicons dashicons-info acf-js-tooltip" title="Check this option to set No caption as the default caption value for all the image elements."></a></span>',
                                ),
                                'default_value' => array(
                                    'elements',
                                    'templates',
                    ...
                    array(
                        ...
                        'sub_fields' => array(
                            ...
                            array(
                                ...
                                'label' => '<strong>Enable the following elements</strong> on Strict Editor View ',
